@echo off
chcp 65001 >nul
title "AI4U RPA - Ordenes de Produccion (Simplificado)"
...
if not exist "src\launchers\launcher_produccion_simple.py" (
    echo ERROR: No se encontró el launcher de producción simplificado
...
echo.
echo Iniciando Launcher de Órdenes de Producción (Simplificado)...
echo.
