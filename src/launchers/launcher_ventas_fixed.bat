@echo off
chcp 65001 >nul
title "AI4U RPA - Ordenes de Venta"

echo.
echo ========================================
echo    AI4U RPA - Ordenes de Venta
echo ========================================
echo.
...
if not exist "src\launchers\launcher_ventas_simple.py" (
    echo ERROR: No se encontro el launcher de ventas
...
echo.
echo Iniciando Launcher de Ordenes de Venta...
echo.
